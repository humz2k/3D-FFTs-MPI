__global__
void d_z_a2a_to_z_pencils(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int nlocal){
...
__global__
void d_z_pencils_to_z_a2a(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int nlocal){
...
__global__ 
void d_x_a2a_to_x_pencils(float* source, float* dest, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_cells_per_stack, int nlocal){
...
__global__
void d_x_pencils_to_x_a2a(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_cells_per_stack, int nlocal){
...
__global__
void d_y_a2a_to_y_pencils(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_ranks_per_tower, int nlocal){
...
__global__
void d_y_pencils_to_y_a2a(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_ranks_per_tower, int nlocal){
