...
extern "C" {
    void launch_d_z_a2a_to_z_pencils(float** source, float** dest, int blockSize, int world_size, int nlocal, int* local_grid_size, int* dims){
...
__global__ 
void d_x_a2a_to_x_pencils(float* source, float* dest, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_cells_per_stack){
...
extern "C" {
    void launch_d_x_a2a_to_x_pencils(float** source, float** dest, int blockSize, int world_size, int nlocal, int* local_grid_size, int* dims){
        ...
        d_x_a2a_to_x_pencils<<<numBlocks,blockSize>>>(source[0], dest[0], n_cells_mini_pencils, n_mini_pencils_per_rank, n_mini_pencils_stacked, n_cells_per_stack);
...
__global__
void d_x_pencils_to_x_a2a(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_cells_per_stack){
...
extern "C" {
    ...
    void launch_d_x_pencils_to_x_a2a(float** source, float** dest, int blockSize, int world_size, int nlocal, int* local_grid_size, int* dims){
        ...
        d_x_pencils_to_x_a2a<<<numBlocks,blockSize>>>(source[0], dest[0], n_cells_per_rank, n_cells_mini_pencils, n_mini_pencils_per_rank, n_mini_pencils_stacked, n_cells_per_stack);
...
__global__
void d_y_a2a_to_y_pencils(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_ranks_per_tower){
...
extern "C" {
    ...
    void launch_d_y_a2a_to_y_pencils(float** source, float** dest, int blockSize, int world_size, int nlocal, int* local_grid_size, int* dims){
        ...
        d_y_a2a_to_y_pencils<<<numBlocks,blockSize>>>(source[0], dest[0], n_cells_per_rank, n_cells_mini_pencils, n_mini_pencils_per_rank, n_mini_pencils_stacked, n_ranks_per_tower);
...
__global__
void d_y_pencils_to_y_a2a(float* source, float* dest, int n_cells_per_rank, int n_cells_mini_pencils, int n_mini_pencils_per_rank, int n_mini_pencils_stacked, int n_ranks_per_tower){
...
extern "C" {
    ...
    void launch_d_y_pencils_to_y_a2a(float** source, float** dest, int blockSize, int world_size, int nlocal, int* local_grid_size, int* dims){
        ...
        d_y_pencils_to_y_a2a<<<numBlocks,blockSize>>>(source[0], dest[0], n_cells_per_rank, n_cells_mini_pencils, n_mini_pencils_per_rank, n_mini_pencils_stacked, n_ranks_per_tower);
