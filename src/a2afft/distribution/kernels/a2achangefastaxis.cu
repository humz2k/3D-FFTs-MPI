...
extern void launch_d_fast_z_to_x(fftPrecision** source, fftPrecision** dest, int* local_grid_size, int blockSize, int nlocal){
...
extern void launch_d_fast_x_to_y(fftPrecision** source, fftPrecision** dest, int* local_grid_size, int blockSize, int nlocal){
...
extern void launch_d_fast_y_to_z(fftPrecision** source, fftPrecision** dest, int* local_grid_size, int blockSize, int nlocal){
